    ...
    return (
        <div className="flex flex-col w-screen h-screen sm:min-h-screen">
            ...
            <div className="animate-[homeCards_1s_forwards] m-auto flex flex-col items-center">
                ...
                <button className="hover:scale-105 duration-200 bg-[rgb(231,92,92,1)] mt-5 cursor-pointer w-50 shadow-md p-4 rounded-4xl font-bold text-gray-700 text-xl relative">
