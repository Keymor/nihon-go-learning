    ...
    return (
        <div className="flex flex-col w-screen min-h-screen">
            ...
            <div className="flex flex-col gap-20 m-auto">
                <div style={{ display: animation.second ? '' : 'none' }} className="flex flex-col mx-auto animate-[homeCards_2s_forwards]">
                    <h1 className="flex mx-auto font-bold text-4xl text-gray-700">Welcome</h1>
                    <p className="flex mx-auto text-xl text-gray-500">Continue your journey to mastering Japanese</p>
                </div>
                <div className="w-full mx-auto flex flex-col">
                    ...
                    <div className="flex flex-row mx-auto gap-30">
