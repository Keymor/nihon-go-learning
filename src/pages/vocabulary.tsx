...
export default function Vocabulary() {
    ...
    return (
        <div className="flex flex-col max-w-screen h-screen sm:min-h-screen relative">
            ...
            <div className="flex w-fit flex-col mx-auto mt-15 relative">
                <div className=" inset-0 absolute size-full rounded-4xl shadow-[-8px_-8px_8px_rgba(255,255,255,1)] z-0"></div>
                <input placeholder="Search" className="z-1 text-center font-bold shadow-lg mx-auto rounded-2xl w-50 h-10" type="text" value={search} onChange={(e) => setSearch(e.target.value)} />
            </div>
